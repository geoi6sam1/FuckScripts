...
// @version        1.0.0
// @description    无视文件大小，无视文件格式，告别卡顿即点即播，自动加载歌词，支持画中画播放
...
obj.replaceNativePlayer = function () {
    $(document.body).on("DOMNodeInserted", ".nd-audio", () => {
        if (!this.only) {
            this.only = true
...
obj.aplayerStart = function () {
    ...
    try {
        ...
        $(body).prepend('<button class="u-dialog__headerbtn" title="关闭播放器" style="top: 6px;right: 9px;"><i class="u-dialog__close u-icon u-icon-close"></i></button>').children(".u-dialog__headerbtn").one("click", () => {
            player.destroy()
        })
